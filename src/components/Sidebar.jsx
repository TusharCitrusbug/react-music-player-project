...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className={`absolute top-0 h-screen w-2/3 bg-gradient-to-to-tl from-white/10 to-[#483d8b] backdrop-blur-lg z-10 pd-6 md:hidden smooth-transition ${mobileMenuOpen ? 'left-0' : '-left-4'}`}>
        <img src={logo} alt="logo" className="w-full h-14 object-contain" />
